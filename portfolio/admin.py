...
admin.site.site_header = getattr(
    settings, "ADMIN_SITE_HEADER", "Ranjith Portfolio Admin"
)
admin.site.site_title = getattr(
    settings, "ADMIN_SITE_TITLE", "Portfolio Admin Portal"
)
admin.site.index_title = getattr(
    settings, "ADMIN_INDEX_TITLE", "Welcome to Portfolio Administration"
)
